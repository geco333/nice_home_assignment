...
class AccountsOverviewPage(BasePage):
    ...
    def get_account_balance(self, account_id: str) -> float:
        row = self.page.locator(f"#accountTable tr:has(a:text-is('{account_id}'))")
    ...
    def click_account(self, account_id: str) -> None:
        self.page.locator(f"#accountTable a:text-is('{account_id}')").click()
        self.page.wait_for_load_state("domcontentloaded")

    def get_total_balance(self) -> float:
        return parse_balance(self.get_text(self.TOTAL_BALANCE))
